...
#Audio file paths and associated delays
sounds = {
    'eye': ('./eye.mp3', 10),
...
#Modify model_points according to the landmarks you have chosen
...
def calculate_head_angle(eye_left, eye_right, nose_tip):
    ...
    return angle_deg
# Load the model
weights_path = weights_path = r'C:\Users\Chandru\Downloads\SafeDriveVision-main\SafeDriveVision-main\yolov5m.pt'
  # Update with the exact path to the weights file
...
'''
        # Dessiner les points de repère
            ...
            if 75 > head_angle and head_angle > 110 :
                ...
                if COUNTER3 >= 6:  
                    sound_thread("regarder")          
                    cv2.putText(img, "9", (x, y - 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                    COUNTER3 = 0
